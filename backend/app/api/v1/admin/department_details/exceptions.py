...
class OrganizationNotFoundError(DepartmentDetailError):
    """The requested organization does not exist."""


class DepartmentNotFoundError(DepartmentDetailError):
    """The requested department does not exist."""


class DepartmentDetailNotFoundError(DepartmentDetailError):
    """The requested department-details record does not exist."""


class DepartmentDetailConflictError(DepartmentDetailError):
